...
public enum RiotUrlApi {
    ...
    // 롤챔프 전체 받는 api
    FIND_BY_CHAMP("https://ddragon.leagueoflegends.com/cdn/15.14.1/data/ko_KR/champion.json"),
    // 게임코드로 전적받는 api
    MATCH("https://asia.api.riotgames.com/lol/match/v5/matches/{matchId}"),
    // 스펠 검색 api
    FIND_BY_SPELL("https://ddragon.leagueoflegends.com/cdn/15.14.1/data/en_US/summoner.json"),
    // 룬 검색 api
    FIND_BY_RUNES("https://ddragon.leagueoflegends.com/cdn/15.14.1/data/ko_KR/runesReforged.json"),
    // 룬만들때 앞에 붙임
